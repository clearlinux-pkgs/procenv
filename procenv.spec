...
Version  : 0.48
Release  : 9
URL      : https://github.com/jamesodhunt/procenv/archive/0.48.tar.gz
Source0  : https://github.com/jamesodhunt/procenv/archive/0.48.tar.gz
...
%prep
%setup -q -n procenv-0.48

%build
export LANG=C
export SOURCE_DATE_EPOCH=1485935477
